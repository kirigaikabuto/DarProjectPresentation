...
type Endpoints interface {
	...
	GetTeacherCourses() func (w http.ResponseWriter,r *http.Request)
}
...
func(ef *endpointsFactory) Profile() func(w http.ResponseWriter,r *http.Request){
	return func(w http.ResponseWriter,r *http.Request){
		...
		//courses,err:=ef.courseRep.GetCoursesByTeacherId(teacher.Id)
		//if err!=nil {
		...
		//payload["info"]=teacher
		respondJSON(w,http.StatusOK,teacher)
	}
}
func(ef *endpointsFactory) GetTeacherCourses() func(w http.ResponseWriter,r *http.Request){
	return func(w http.ResponseWriter,r *http.Request){
