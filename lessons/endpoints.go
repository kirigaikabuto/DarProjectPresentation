...
type endpointsFactory struct {
	...
	attendanceRep attendances.AttendanceRepository
	materialRep materials.MaterialRepository
}
func NewEndpointsFactory(lessonrep LessonRepository,attendanceRep attendances.AttendanceRepository,materialRep materials.MaterialRepository) Endpoints{
...
func(ef *endpointsFactory) GetMaterial(idParam string) func(w http.ResponseWriter,r *http.Request){
	return  func(w http.ResponseWriter,r *http.Request) {
		...
		material,err:=ef.materialRep.GetByLessonId(id)
		if err!=nil{
			respondJSON(w, http.StatusBadRequest, err.Error())
			return
		}
...
func(ef *endpointsFactory)GetAttendance(idParam string) func(w http.ResponseWriter,r *http.Request){
	return func(w http.ResponseWriter,r *http.Request){
		...
		attendances,err:=ef.attendanceRep.GetByLesson(id)
		if err!=nil{
			respondJSON(w,http.StatusInternalServerError,err.Error())
			return
		}
		respondJSON(w,http.StatusOK,attendances)
	}
}
